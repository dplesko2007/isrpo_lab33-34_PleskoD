...
public class NoteRepository : INoteRepository {
    ...
    public async Task<Note?> FindAsync(int id) => await _db.Notes.FindAsync(id);

    public async Task<int> GetCountByCategoryAsync(int categoryId) => await _db.Notes.CountAsync(n => n.CategoryId == categoryId);
}